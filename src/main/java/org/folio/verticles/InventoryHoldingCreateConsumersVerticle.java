...
public class InventoryHoldingCreateConsumersVerticle extends InventoryConsumersVerticle {

  @Autowired
  public InventoryHoldingCreateConsumersVerticle(KafkaConfig kafkaConfig, AbstractApplicationContext springContext) {
