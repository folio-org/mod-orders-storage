...
public class InventoryItemCreateConsumersVerticle extends InventoryConsumersVerticle {

  @Autowired
  public InventoryItemCreateConsumersVerticle(KafkaConfig kafkaConfig, AbstractApplicationContext springContext) {
