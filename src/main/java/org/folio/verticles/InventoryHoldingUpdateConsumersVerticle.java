...
import org.folio.event.handler.HoldingUpdateAsyncRecordHandler;
...
public class InventoryHoldingUpdateConsumersVerticle extends InventoryConsumersVerticle {

  private static final InventoryEventType eventType = InventoryEventType.INVENTORY_HOLDING_UPDATE;

  @Autowired
  public InventoryHoldingUpdateConsumersVerticle(KafkaConfig kafkaConfig, AbstractApplicationContext springContext) {
    super(InventoryEventType.INVENTORY_HOLDING_UPDATE, HoldingUpdateAsyncRecordHandler::new, kafkaConfig, springContext);
  }
