...
public enum TestEntities {
  ...
  ORDER_TEMPLATE_CATEGORIES("/orders-storage/order-template-categories", OrderTemplateCategory.class, TestData.OrderTemplateCategory.DEFAULT, "name", "Non-Fiction", 0),
