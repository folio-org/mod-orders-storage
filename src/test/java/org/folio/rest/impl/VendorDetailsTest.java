...
public class VendorDetailsTest extends OrdersStorageTest {
  ...
  public void testVendorDetails() {
    ...
    try {
      ...
      testEntityCreated(VENDOR_DETAIL_ENDPOINT, 17);
      ...
      deleteData(VENDOR_DETAIL_ENDPOINT, sampleId);

      logger.info("--- mod-orders-storage Vendor Details test: Verify Vendor Detail is deleted with ID ");
      testVerifyEntityDeletion(VENDOR_DETAIL_ENDPOINT, sampleId);
    }
  }
  ...
  private void testInvalidVendorDetailId() {
    ...
    getDataById(VENDOR_DETAIL_ENDPOINT, INVALID_VENDOR_DETAIL_ID).then()
      .statusCode(404);
  }
